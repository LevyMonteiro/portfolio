      ...
      <section
        className={`${
          theme === 'light'
            ...
            : 'bg-black text-white'
        } w-screen min-h-screen flex flex-col justify-center items-center py-16`}
      >
        <div
          id='project-container'
          className='w-[1184px] h-min flex flex-col items-center justify-center gap-8'
        >
          <div
            id='cols-wrapper'
            className='w-[1184px] h-min flex items-start justify-center gap-8'
          >
            <div
              id='col1'
              className='flex flex-col justify-start items-start gap-12 w-1/3 h-full'
            >
              <h1
                className={`${
                  theme === 'light'
            ...
            <div
              id='col2'
              className='flex flex-col h-full w-2/3 gap-6 items-center'
            >
              <h2 className='text-3xl font-semibold font-poppins text-left w-full'>
                Project Overview
              </h2>
              ...
              {about.map((d) => {
                return (
                  <p className='opacity-85 text-lg w-full text-left'>{d}</p>
                );
              })}
              ...
              <video src={demo} className='w-11/12' controls></video>
            </div>
          </div>
        </div>
      </section>
