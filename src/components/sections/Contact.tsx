...
export default function Contact() {
  ...
  return (
    ...
    >
      <div
        id='wrapper'
        className='grid grid-cols-1 xl:grid-cols-2 justify-center items-center max-w-[1184px] w-4/5 xl:w-auto gap-12'
      >
        <div
          id='intro'
          className='flex flex-col gap-16 h-full justify-between pb-[68px]'
        >
          <h2 className='text-white text-4xl font-poppins font-semibold text-center xl:text-left'>
            Say Hello!
          </h2>

          <div id='intro-content' className='flex flex-col gap-5 text-pretty'>
            <p className='opacity-85 text-lg text-center xl:text-left'>
        ...
        <div id='form' className='flex flex-col gap-6 h-full'>
          <h2 className='text-white text-4xl mb-2 font-poppins font-semibold text-center xl:text-left'>
            Get in Touch
          </h2>
